 ...
 * @Description: 
 * @Author: hans
 * @Date: 2020-06-24 09:20:55
 * @LastEditTime: 2020-06-24 09:36:16
 * @LastEditors: hans
 */
#include <stdio.h>
...
ID* Delete(ID *head)
{
	...
	char temp;			//同上
	int i;				//i是这个函数的关键，因为我尝试了很多种方法，都是有这样那样的问题，虽然这个方法没有效率，但是可行
